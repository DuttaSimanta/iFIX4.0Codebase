...
func (mdao DbConn) GetResolutiondetails(page *entities.SLATabEntity) (entities.SLAResolutionmeterEntity, error) {
...
func (mdao DbConn) GetResponsedetails(page *entities.SLATabEntity) (entities.SLAResponsemeterEntity, error) {
	logger.Log.Println("GetResponsedetails query -->", response)
	logger.Log.Println("GetResponsedetails parameters -->", page.RecordID, page.RecordID, page.ClientID, page.Mstorgnhirarchyid, page.RecordID, page.RecordID)
