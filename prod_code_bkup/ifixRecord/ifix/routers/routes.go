...
var routes = Routes{
	Route{
		...
		Route{
		"insertbulkrecordtermvalues",
		"POST",
		"/insertbulkrecordtermvalues",
		handlers.InsertBulkRecordTermvalues,
	},
Route{
	...
	Route{
        "updaterecordfulticketiddeletelag",
        "POST",
        "/updaterecordfulticketiddeleteflag",
        handlers.UpdateRecordfulTicketIdDeleteFlag,
    },

    Route{
        "updatetrnrecordcodedeleteflgbyid",
        "POST",
        "/updatetrnrecordcodedeleteflgbyid",
        handlers.UpdateTrnRecordCodeDeleteFlgById,
    },
}
