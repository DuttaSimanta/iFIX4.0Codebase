...
func InsertBulkRecordTermvalues(w http.ResponseWriter, req *http.Request) {
	var data = entities.BulkRecordcommonEntity{}
	...
	if jsonError != nil {
		...
		//models.APIcall()
		data, success, _, msg := models.InsertBulkRecordTermvalues(&data)
