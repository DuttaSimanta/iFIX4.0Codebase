...
func RecordNoGen() {
	...
	model.Recordnumbergeneration()
}
func RecordNoDelete() {
	Logger.Log.Println("===========================RecordNoDeletion Started===============")
	model.Deleterecordcode()
}
...
func main() {
	...
	s.Every(1800).Seconds().Do(RecordNoGen)
	s.Every(6).Hours().Do(RecordNoDelete)
